...
This guide covers running The Daily Feed 1.2.4 in production with source-built containers and a trusted HTTPS reverse proxy.
...
| `APP_VERSION` | `1.2.4` | Build/runtime metadata in logs. |
