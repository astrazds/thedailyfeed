...
This guide covers running The Daily Feed 1.2.5 in production with source-built containers and a trusted HTTPS reverse proxy.
...
| `APP_VERSION` | `1.2.5` | Build/runtime metadata in logs. |
